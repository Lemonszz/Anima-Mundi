 ...
 */
public class BlockAnimaGenerator extends BlockAnima implements ILinkable
{
	protected BlockAnimaGenerator()
	{
		super("anima_generator", Material.WOOD);
	}
	...
	{
		return new TileEntityAnimaGenerator();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	{
		...
		player.openGui(Anima.Instance, 1, world, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
}
